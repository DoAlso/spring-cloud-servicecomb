...
import com.sample.scca.domain.EncryptKey;
import com.sample.servicecomb.scca.rest.dto.EncryptKeyDto;
import com.sample.servicecomb.scca.rest.dto.base.WebResp;
...
public class EncryptKeyController extends BaseController {
    private static Logger log = LoggerFactory.getLogger(EncryptKeyController.class);
