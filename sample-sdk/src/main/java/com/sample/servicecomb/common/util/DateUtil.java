...
public final class DateUtil {
    ...
    /**
     * 英文周名称转换为中文，入参固定，不能识别的入参均返回null
     *
     * @param englishWeekName monday\tuesday\wednesday\thursday\friday\saturday\sunday
     * @return 一\二\三\四\五\六\七
     */
    public static String getChineseWeekNumber(String englishWeekName) {
        switch (englishWeekName) {
            case DateConstants.MONDAY: return "一";
            case DateConstants.TUESDAY: return "二";
            case DateConstants.WEDNESDAY: return "三";
            case DateConstants.THURSDAY: return "四";
            case DateConstants.FRIDAY: return "五";
            case DateConstants.SATURDAY: return "六";
            case DateConstants.SUNDAY: return "日";
            default: return null;
        }
    }
    ...
    public static Date string0DateTime(String str) {
        if (str.split(DateConstants.SEPARATOR_ONE).length > 1) {
            return string2Date(str, "yyyy-MM-dd HH:mm:ss");
        } else if (str.split(DateConstants.SEPARATOR_TWO).length > 1) {
            return string2Date(str, "yyyy/MM/dd HH:mm:ss");
        }
        return string2Date(str, "yyyy-MM-dd HH:mm:ss");
    }
    ...
    public static String getChineseWordByCount(int i) {
        switch (i) {
            case DateConstants.JAN: return "一";
            case DateConstants.FEB: return "二";
            case DateConstants.MAR: return "三";
            case DateConstants.APR: return "四";
            case DateConstants.MAY: return "五";
            case DateConstants.JUN: return "六";
            case DateConstants.JUL: return "七";
            case DateConstants.AUG: return "八";
            case DateConstants.SEPT: return "九";
            case DateConstants.OCT: return "十";
            case DateConstants.NOV: return "十一";
            case DateConstants.DEC: return "十二";
            default: return null;
        }
    }
